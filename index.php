...
Genre: <?php echo ($radio_info['genre']);?><br />
	...
	<center><embed allowfullscreen="true" allowscriptaccess="always" flashvars="src=rtmp://edge.okeinfo.net/live/mncoke1_128.stream&amp;streamType=live&amp;autoPlay=true&amp;scaleMode=stretch" height="400" rln="" src="FlashMediaPlayback_101.swf" style="border: 0px solid rgb(255, 255, 255); margin-bottom: -px; margin-left: px; margin-right: 0px; margin-top: px; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; padding-top: 0px;" type="application/x-shockwave-flash" width="570"></embed>,br /> Reload Browser Jika RCTI Tidak Tampil </center></div></div></div></div></div><h3 style="text-align: center;">RCTI Online Streaming Server 3</h3><div style="text-align: center;"><div style="margin: 1px;"><div class="smallfont" style="margin-bottom: 1px;"><input onclick="if (this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display != '') { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = ''; this.innerText = ''; this.value = 'Sembunyikan RCTI Streaming Server 3'; } else { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = 'none'; this.innerText = ''; this.value = 'RCTI TV Streaming Server 3'; }" style="font-size: 14px; margin: 0px; padding: 0px; width: auto;" type="button" value="RCTI TV Streaming Server 3" /></div><div class="alt2"><div style="display: none;"><div style="background: none repeat scroll 0% 0% #ffffff; padding: 10px; text-align: justify;"><center><script type="text/javascript">
//<![CDATA[
<!--
